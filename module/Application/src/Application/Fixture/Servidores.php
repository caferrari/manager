...
class Servidores extends AbstractFixture
{
    ...
    protected function loadOrgaos($items)
    {
        ...
        $repository = $this->em->getRepository('Application\Entity\Orgao');
        $service = new \Application\Service\Orgao($this->em);
    ...
    protected function loadCargoEfetivo($items)
    {
        ...
        $repository = $this->em->getRepository('Application\Entity\CargoEfetivo');
        $service = new \Application\Service\CargoEfetivo($this->em);
    ...
    protected function loadCargoComissao($items)
    {
        ...
        $repository = $this->em->getRepository('Application\Entity\CargoComissao');
        $service = new \Application\Service\CargoComissao($this->em);
    ...
    protected function loadSimbolo($items)
    {
        ...
        $repository = $this->em->getRepository('Application\Entity\Simbolo');
        $service = new \Application\Service\Simbolo($this->em);
    ...
    protected function loadSetores($items)
    {
        ...
        $repository = $this->em->getRepository('Application\Entity\Setor');
        $service = new \Application\Service\Setor($this->em);
    ...
    protected function loadServidores($items)
    {
        ...
        $repository = $this->em->getRepository('Application\Entity\Servidor');
        $service = new \Application\Service\Servidor($this->em);
